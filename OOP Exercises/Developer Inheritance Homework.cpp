...
public:
    ...
    clsDeveloper(int ID, string FirstName, string LastName, string FullName, string Email, string Phone, string Title, string Department, float Salary,string MainProgrammingLanguage)
...
int main()
{
    ...
    clsDeveloper Dev1(8, "Dev", "Onus", "Dev Onus", "dev@gmail.com", "+1", "Junior", "DevSecOps", 8888, "CPP");
